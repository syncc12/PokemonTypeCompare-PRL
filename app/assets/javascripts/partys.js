  ...
  $(function (_SelectionProcess2) {
    $('#add-party-button').on('partyBoxHoldChange', function() {
      ...
      //   console.log("selected")
        ...
        $.ajax({
          type: 'POST',
          url:  "/partys/" + current_user.id + ".json",
          dataType: 'json',
